...
// ----------------------------------------------------------------------------
// 666 'MySoulCoin' crowdsale/token contract.
//
// NOTE: Use at your own risk as this contract has not been audited
//
// Deployed to : Mattia Fregola
// Symbol      : 666
// Name        : MySoulCoin
// Total supply: 100000000
// Decimals    : 18
//
// Based on code by the Jesus Coin crowdsale. 
// At the end of crowdsale
//    15% of ETH raised will be sent to them.
//    15% of ETH raised will be sent to Sydney Ethereum workshop
//    The rest will hopefully allow me not to work for 6 months and 
//    dedicate time and thoughts to improving the world.
//    drop me an email for any question!
// ----------------------------------------------------------------------------
pragma solidity ^0.4.16;
...
/**
 * @title MySoulCoin token
 * @dev Simple ERC20 Token example, with mintable token creation
 * @dev Issue: * https://github.com/OpenZeppelin/zeppelin-solidity/issues/120
 * Based on code by TokenMarketNet: https://github.com/TokenMarketNet/ico/blob/master/contracts/MintableToken.sol
 */
 
contract MySoulCoin is StandardToken, Ownable, TokenDestructible {

  string public name = "My Soul Coin";
 ...
 * as they arrive.
 */
contract MySoulCrowdsale is Ownable, Pausable, TokenDestructible {
  using SafeMath for uint256;

  MySoulCoin public token;
  ...
  function MySoulCrowdsale() payable {
    token = new MySoulCoin();
  }
